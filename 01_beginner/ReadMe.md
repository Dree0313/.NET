...
- [CLR (Common Language Runtime): Executes programs and manages memory](.Net_Overview/02_CLR_(Common_Language_Runtime):_Executes_programs_and_manages_memory.cs)
