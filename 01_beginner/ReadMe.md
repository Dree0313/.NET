...
### C# Basics
- [Variables: Declaring and using different types (`int`, `string`, `bool`, etc.)](02_C#_Basics/01_Variables:_Declaring_and_using_different_types_(int,_string,_bool,_etc.).cs)
